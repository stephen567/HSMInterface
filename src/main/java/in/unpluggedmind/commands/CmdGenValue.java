...
public class CmdGenValue {
	...
	public static String calculate(CryptValues val, Keys keys) 
		...
		{
		case "CVV" :
			return calculateCVV(keys);
		case "PVV" :
			return calculatePVV(keys);
		case "PVVcust" :
			return calculatePVVcust(keys);
		case "PINLMK" :
			return translatePINLMK(keys);
		case "PINBlock" :
			return calculatePINBlock(keys);
		case "EncPIN" :
	 ...
	 * Service Code
	 */
	private static String calculateCVV(Keys k) {
		return "CW"
				+ k.getCVK_LMK() //"U8F3CE2A39000981D4F080FC68469DB1D"
				+ "4000000000000002"
				+ ";"
				+ "2012"
				+ "101";
	 ...
	 * PVKI				
	 */
	private static String calculatePVV(Keys k) {
		return "DG"
				+ k.getPVK_LMK() //"U1661EAF0B01F534C3A23292A67818C91"
				+ "01234"
				+ "000000000000"
				+ "1;";	
	}
	 ...
	 * PVKI
	 */
	private static String calculatePVVcust(Keys k) {
		return "FW"
			+ "001"
			+ k.getZPK_LMK() //"UD25B25E64AFD3626E9D9DCCDB49CFE9E" //"U951E300CD42EF71EF1C70EA36392EC5C"
			+ k.getPVK_LMK() //"U81E0C5387FD156F911DF25D95024806B"
			+ "CBA110B75A5D592E" 
			+ "01"
			+ "000000000000"
			+ "1";
	 ...
	 * Account (12)
	 */
	private static String translatePINLMK(Keys k) {
		return "JE"					
				+ k.getZPK_LMK() //"U5D836C6EB367308DF59729139A04E017"
				+ "CBA110B75A5D592E"
				+ "01"
				+ "000000000000";
	 ...
	 */
	private static String calculatePINBlock(Keys k) 
			throws InvalidKeyException, SMException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException {
		...
		GenPINBlock.calculateEncPINBlock(pin, format, accountNum, k.getZPK_CLR());
